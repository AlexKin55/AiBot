...
class EspSound
{
    ...
    // Гарантирует, что динамик инициализирован и готов к воспроизведению.
    // Если микрофон его выключил (общий I2S на CoreS3) — переинициализирует.
    // Возвращает true, когда можно играть.
    bool ensureReady();
